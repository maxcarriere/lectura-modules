"""Lectura G2P — Convertisseur graphème-phonème pour le français (backend CRF).
...
class LecturaG2P:
    """Convertisseur graphème-phonème pour le français (backend CRF).

    Zéro dépendance externe. Utilise un modèle CRF avec décodage Viterbi
    pur Python.

    Args:
        model_path: Chemin vers le modèle CRF (fichier JSON).
