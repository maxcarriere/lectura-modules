#!/usr/bin/env python3
"""Evaluation du G2P Lectura (backend CRF) sur un fichier gold (dico.csv).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluation du G2P Lectura (CRF)")
    parser.add_argument(
        "--gold", required=True,
    ...
    g2p_base = LecturaG2P(model_path)
    ...
    if corr_path:
        ...
        g2p_corr = LecturaG2P(model_path, corrections_path=corr_path)
