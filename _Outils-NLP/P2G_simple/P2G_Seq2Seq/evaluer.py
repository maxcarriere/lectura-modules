#!/usr/bin/env python3
"""Evaluation du P2G Lectura (backend Seq2Seq) sur un fichier gold (dico.csv).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluation du P2G Lectura (Seq2Seq)")
    parser.add_argument(
        "--gold", required=True,
    ...
    if enc_path and dec_path and vocab_path:
        ...
        print(f"\n  Modele Seq2Seq non trouve ({model_dir}), utilisation table + regles")
        p2g = LecturaP2G()
