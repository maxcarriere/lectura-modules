#!/usr/bin/env python3
"""Evaluation du P2G Lectura (backend CRF) sur un fichier gold (dico.csv).
...
from lectura_p2g import LecturaP2G, iter_phonemes
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluation du P2G Lectura (CRF)")
    parser.add_argument(
        "--gold", required=True,
    ...
    if model_path.exists():
        ...
        print(f"\n  Modele CRF non trouve ({model_path}), utilisation table + regles")
        p2g = LecturaP2G()
