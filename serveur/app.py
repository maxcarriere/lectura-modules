...
from serveur.routers import g2p, p2g, aligneur, formules

app = FastAPI(
    title="Lectura API",
    description="API pour les modules Lectura — G2P, P2G, Aligneur, Formules",
    version="1.0.0",
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://www.lec-tu-ra.com", "http://localhost:*"],
