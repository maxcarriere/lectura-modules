...
from lectura_diphone._compression import load_compressed
from lectura_diphone._world import (
...
class DiphoneEngine:
    ...
    def load(self, models_dir: str | Path | None = None) -> None:
        ...
        """
        from lectura_diphone._chargeur import find_models_dir
        ...
        if dpk_path.exists():
            ...
            from lectura_diphone._crypto import load_encrypted_model
            import gzip
            import io
    ...
    def _group_f0_contour_corpus(cls, phones: list[str], mode: SynthMode,
        ...
        from lectura_diphone._prosody_corpus import generate_corpus_prosody
    ...
    def synthesize_groups(
        ...
        if timbre is not None:
            from lectura_diphone._timbre import load_signature
    ...
    def _apply_retimbre(
        ...
        from lectura_diphone._retimbre import RetimbreEngine
        import librosa
