"""Inférence pur Python (zéro dépendance) pour le modèle unifié P2G V2 (avec lex_features).
...
class PureInferenceEngine:
    """Inférence pur Python pour le modèle unifié P2G V2."""
    ...
    def analyser(
        ...
        *, use_lex: bool = True,
        ...
        for w in range(n_words):
            ...
            if use_lex and self.has_lex_proj and ortho_words and w < len(ortho_words):
                lex_feats = _build_lex_features_pure(ortho_words[w], self.lexicon)
