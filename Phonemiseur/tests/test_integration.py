...
from lectura_phonemiseur.tokeniseur import tokeniser, phrase_vers_chars
...
from lectura_phonemiseur.utils.ipa import iter_phonemes, est_voyelle, est_consonne
from lectura_phonemiseur.utils.g2p_labels import _CONT, labels_from_alignment, reconstruct_ipa
...
class TestPosttraitement:
    ...
    def test_corriger_g2p_with_table(self):
        corrections_path = Path(__file__).resolve().parent.parent / "src" / "lectura_phonemiseur" / "data" / "g2p_corrections_unifie.json"
...
_DATA_DIR = Path(__file__).resolve().parent.parent / "src" / "lectura_phonemiseur" / "data"
