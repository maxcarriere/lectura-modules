...
from lectura_phonemiseur._chargeur import ponctuation_lecture as _load_ponctuation_lecture
        ...
        if kind == "ponctuation":
            ...
            if item_idx in compound_ranges:
                ...
                sub_liaisons = [liaison_list[i] if i < len(liaison_list) else "none"
                                for i in range(c_start, c_end)]
                from lectura_phonemiseur.posttraitement import appliquer_liaison
