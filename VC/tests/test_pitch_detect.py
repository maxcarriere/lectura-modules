...
from lectura_vc._pitch_detect import (
    auto_adapt,
    compute_pitch_shift,
    compute_protect,
    detect_mean_f0,
...
class TestDetectMeanF0:
    def test_sine_wave(self):
        ...
        # Tolerance large car pyin n'est pas parfait sur un sinus pur
    ...
    def test_noise(self):
        ...
        f0 = detect_mean_f0(audio, sr=16000)
        # Le bruit peut produire des faux positifs F0, mais a faible amplitude
        # pyin retourne parfois une valeur basse ; on verifie juste que ca ne plante pas
...
class TestComputePitchShift:
    def test_same_f0(self):
        """Meme F0 -> shift = 0."""
        # On ne peut pas tester directement car source_f0 != speaker F0
        # Mais on peut verifier la formule
        shift = compute_pitch_shift(200.0, "ezwa")  # ezwa ~195 Hz
        assert abs(shift) < 1.0  # Proche de 0
...
class TestAutoAdapt:
    def test_returns_tuple(self):
        ...
        # Source ~200 Hz femme -> bernard ~130 Hz homme -> shift negatif
