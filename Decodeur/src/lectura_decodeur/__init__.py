"""Lectura Decodeur — Decodeur phonetique du francais.
...
from lectura_decodeur._parse_ctc import ParseResult, parse_ctc_output, parse_ctc_v2
...
def creer_engine(
    ...
    """
    if mode == "api":
        from lectura_decodeur._inference_api import ApiCTCEngine
    ...
    if mode in ("auto", "onnx"):
        try:
            from lectura_decodeur._inference_onnx import OnnxCTCEngine
