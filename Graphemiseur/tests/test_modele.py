...
import torch
from lectura_graphemiseur.modele import UnifiedP2G, MultiTaskLoss
...
def test_p2g_labels():
    ...
    from lectura_graphemiseur.utils.p2g_labels import labels_from_p2g_alignment, reconstruct_ortho, _CONT
