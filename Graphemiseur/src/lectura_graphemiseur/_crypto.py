"""Dechiffrement du modele ONNX chiffre (.enc) au runtime.

Les constantes de derivation de cle sont identiques a encrypt_model.py
mais dispersees differemment dans le code.
"""
...
# Fragments de sel — meme materiel que encrypt_model.py
_P1 = "Lectura-NLP-P2G"
_P2 = 0x5032
