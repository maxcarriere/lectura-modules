...
class UnifiedP2GDataset:
    ...
    def __init__(
        ...
        from lectura_graphemiseur.utils.aligneur import aligner
        from lectura_graphemiseur.utils.p2g_labels import _CONT, labels_from_p2g_alignment, reconstruct_ortho
